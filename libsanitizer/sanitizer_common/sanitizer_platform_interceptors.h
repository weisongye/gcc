...
#if SANITIZER_LINUX && !SANITIZER_UCLIBC
# define SI_LINUX_NOT_UCLIBC 1
#else
# define SI_LINUX_NOT_UCLIBC 0
#endif
...
#define SANITIZER_INTERCEPT_GLOB SI_LINUX_NOT_ANDROID && SI_LINUX_NOT_UCLIBC
